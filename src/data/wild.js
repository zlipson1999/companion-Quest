...
export const WILD_COMPANIONS = {
  ...
  kernelit: { hp: 36, xp: 36, bond: 8 },
  plinkbat: { hp: 38, xp: 36, bond: 8 },
  propfin: { hp: 44, xp: 36, bond: 8 },
  clinket: { hp: 46, xp: 36, bond: 8 },
  glintfoal: { hp: 40, xp: 36, bond: 8 },
  bellbun: { hp: 40, xp: 36, bond: 8 },
  nectlet: { hp: 40, xp: 36, bond: 8 },
  chipmagma: { hp: 46, xp: 36, bond: 8 },
  burrcalf: { hp: 50, xp: 36, bond: 8 },
  bloopot: { hp: 48, xp: 36, bond: 8 },
  figbat: { hp: 38, xp: 36, bond: 8 },
  ammonip: { hp: 44, xp: 36, bond: 8 },
