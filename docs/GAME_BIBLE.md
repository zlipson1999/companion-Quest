...
Dapple→Glimmoth→Leaflight, Stillcup→Dewbasin→Rainhold) plus forty
horizon families reserved for named trails that are not walkable yet
(Brineling→Tidecrown through Tinkid→Summitbell; see
docs/HORIZON_FAMILIES.md). Creatures carry
...
- Creatures 48×48 authored @2× = 96 px: **174 companions — 58 families of 3
...
| What is the content target at launch? | **OPEN.** Current roster is 174 companion forms across 58 families plus 6 obstacles; the 40 horizon families are Index-visible and reserved for named trails that are not walkable yet. |
...
9. Horizon roster is 40 additional families (58 total). Expand past that only after the content validator,
