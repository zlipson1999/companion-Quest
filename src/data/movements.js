...
export const MOVEMENTS = [
  ...
  { id: 'wallpushup', name: 'Wall Push-Up', pattern: 'push', equipment: 'bodyweight', unit: 'reps', load: 1,
    primary: ['chest', 'triceps'], secondary: ['shoulders', 'core'],
    cues: ['Hands on the wall at shoulder height', 'Body one straight line, heels down', 'Chest toward the wall', 'Push the wall away to stand tall'] },
  ...
  { id: 'sittostand', name: 'Sit-to-Stand', pattern: 'squat', equipment: 'bodyweight', unit: 'reps', load: 1,
    primary: ['quads', 'glutes'], secondary: ['core', 'hamstrings'],
    cues: ['Sit tall near the chair\'s edge', 'Lean forward, drive through the heels', 'Stand all the way up', 'Sit back down slowly — no dropping'] },
  ...
  { id: 'marchinplace', name: 'March in Place', pattern: 'condition', equipment: 'bodyweight', unit: 'seconds', load: 1,
    primary: ['quads', 'calves'], secondary: ['core'],
    cues: ['Knees toward hip height', 'Arms swing with the legs', 'Land soft, whole foot', 'Easy breathing — you can talk'] },
  { id: 'standingkneeraise', name: 'Standing Knee Raise', pattern: 'condition', equipment: 'bodyweight', unit: 'reps', load: 1,
    primary: ['quads', 'core'], secondary: ['calves'],
    cues: ['Stand tall, hands at hip height', 'Raise one knee to your hands', 'Lower with control, then switch', 'Balance comes from a braced middle'] },
