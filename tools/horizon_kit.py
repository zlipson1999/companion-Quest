...
FAMILIES = [
    ...
    ('zapram', 'voltibex', 'stormhorn', 'wind', (62, 104, 162), 0.48,
     ...
     ('A woolly kid with two glowing horn buds. Ridges make it spark.',
      'Nimble ibex, zigzag horns. Height is a habit it already has.',
      'Branching lightning horns, storm-cloud wool. High country, kept.')),
