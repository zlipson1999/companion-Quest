...
export function buildCoachContext(state, companion) {
  ...
  lines.push('Gym rule: bicycle and treadmill miles are cardio records only; they never advance a trail, roll trail encounters or milestones, or mint Trail Credit.');
