...
// first-bond companion AND sets a real playstyle: route pacing, trail
...
// Compatibility alias while save/actions still call this field starterId.
GOALS.forEach((goal) => { goal.starterId = goal.companionId; });
